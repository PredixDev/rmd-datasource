...
public class AssetDatagridServiceImpl extends DatagridServiceImpl implements
	 ...
	 */
	@Override
	public DatagridResponse getDatagridResponseObject() throws IOException {
	...
	private List<Column> getColumnData() {
		...
		Column column = new Column("meter","string","text",new Double(25),"Meter Name");  //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column("alertStatus","string","text",new Double(20),"Alert Status"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column("currentValue","number","text",new Double(20),"Current value"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column("unit","number","text",new Double(10),"Units"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column("lastMeterReading","string","text",new Double(10),"Last Meter Reading"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column("thresholdMin","number","text",new Double(10),"Threshold Minimum"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column("thresholdMax","number","text",new Double(10),"Threshold Maximum"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column("deltaThreshold","string","text",new Double(25),"Delta Threshold "); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
	...
	public Response getDatagrid(String id, String appId, String authorization)
        ...
        {
            log.error("unable to getDatagrid", e);
            throw e;
        }
	}
	...
	public Response getDatagridSummary(String id, String appId,
		...
		try {
			...
			log.error("unable to get datagrid summary, id = " + id, e); //$NON-NLS-1$
			throw e;
		}
	}
	...
	/**
	 * @param assetDataSourceHandler the assetDataSourceHandler to set
	 */
	public void setAssetDataSourceHandler(DataSourceHandler assetDataSourceHandler) {
