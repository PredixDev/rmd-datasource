...
public class KpiDatagridServiceImpl implements KpiDatagridService {
	...
	public DatagridResponse getDatagridResponseObject() {
		...
		response.getTableData().add(getMapper().convertValue(datagrid, Map.class));
	...
	@Override
	public Response getDatagrid(String entityType, String id, String authorization) throws Throwable {
		try {
